  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (correct) {
        ...
        router.push(`/rounds/shiftverse/result?success=true&word=${encodeURIComponent(decryptedWord || currentGuess)}`);
      } else {
  ...
  return (
    <div className="puzzle-board slide-up">
      ...
      <div className="puzzle-board__header">
        {/* Was "← CHANGE DIMENSION", which sent the player back to the entry
            screen to type a different team number. That screen is gone — the
            team comes from the session cookie — so this is the way out of the
            round, and it says so. */}
